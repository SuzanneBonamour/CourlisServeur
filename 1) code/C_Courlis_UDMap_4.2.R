...
# ordre spécifique
hotspot_foraging_ID_hotspot$n_ID <- factor(hotspot_foraging_ID_hotspot$n_ID,
                                           levels = c("1","2","3","4","34"))
# plot
tmap_mode("view")
UDMap_foraging_hotspot <- tm_scalebar() +
  ...
  tm_polygons(border.col = "grey", fill = "n_ID", fill_alpha = 1,
              palette = c("1" = "gray95", "2" = "gray85", "3" = "#59C8B2FF", "4" = "#0095AFFF", "34" = "#26185FFF")) + # " palette_foraging"
  tm_shape(site_baguage) +
  tm_text("icone", size = 1.5) +
  tm_shape(terre_mer) +
...
# tmap_mode("view")
# 
# UDMap_roosting_rep_inter_month <- tm_text("NOM_SITE", size = 1) +
#   tm_shape(results_kud.roosting_ZOOM_month) + 
#   tm_facets("ID") +
...
# tmap_mode("view")
# 
# UDMap_foraging_rep_inter_month <- tm_shape(results_kud.foraging_ZOOM_month) + 
#   tm_facets("ID") +
...
# # tmap_mode("view")
# # 
# # UDMap_roosting_rep_inter_week <- tm_shape(results_kud.roosting_ZOOM_week) + 
# #   tm_facets("ID") +
...
# # tmap_mode("view")
# # 
# # UDMap_foraging_rep_inter_week <- tm_shape(results_kud.foraging_ZOOM_week) + 
# #   tm_facets("ID") +
