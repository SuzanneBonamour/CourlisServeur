...
# # roosting : 3h après la dernière marée basse, 3h avant la prochaine
# 
# aa <- inter_sf %>%
#   arrange(date)
# 
...
#   # print(time_i)
#   # period limit
#   foraging_low = time_i - (3600*1.5)
#   foraging_up = time_i + (3600*1.5)
#   roosting_low = time_i + (3600*4)
#   roosting_up = time_i1 - (3600*4)
#   # assignation des behaviours
#   info <- aa %>%
...
# 
# # save
# write.table(behaviour_dt_1, paste0(data_generated_path_serveur, "behaviour_1304h.txt"),
#             append = FALSE, sep = ";", dec = ".", col.names = TRUE)
# 
# ###
# ####
...
# ###
# 
# behaviour_1304h <- read.table(paste0(data_generated_path_serveur, "behaviour_1304h.txt"), 
#                             header = T, sep = ";")
# behaviour_1304h_spa <- st_as_sf(behaviour_1304h, coords = c("x", "y"), crs = 4326)
# behaviour_1304h_spa$lon <- behaviour_1304h$x
# behaviour_1304h_spa$lat <- behaviour_1304h$y
# 
# # BOX
# # behaviour_1304h_box <- st_intersection(behaviour_1304h_spa, BOX_4326) # time consuming...
# # st_write(behaviour_1304h_box, paste0(data_generated_path_serveur, "behaviour_1304h_box.gpkg"), append = FALSE)
# 
# # miniBOX
# behaviour_1304h_minibox <- st_intersection(behaviour_1304h_spa, miniBOX_4326) # time consuming...
# st_write(behaviour_1304h_minibox, paste0(data_generated_path_serveur, "behaviour_1304h_minibox.gpkg"), append = FALSE)
# 
# ###
# ####
# # 1000 POINTS & 56 DAYS ---------------------------------------------------------
...
# 
# # BOX
# # behaviour_1304h_box <- st_read(paste0(data_generated_path_serveur, "behaviour_1304h_box.gpkg"))
# # 
# # behaviour_1304h_box_1000_56 <- behaviour_1304h_box %>%
# #   group_by(id) %>%
# #   mutate(nb_point = n()) %>%
# #   mutate(nb_days = difftime(max(date), min(date), units = "days")) %>%
# #   filter(nb_point >= 1000) %>%
# #   filter(nb_days >= 28*2)
# # 
# # behaviour_1304h_box_nb_ind_1000_56 <- length(unique(behaviour_1304h_box_1000_56$id)) ; behaviour_1304h_box_nb_ind_1000_56
# # 
# # st_write(behaviour_1304h_box_1000_56, paste0(data_generated_path_serveur, "behaviour_1304h_box_1000_56.gpkg"), append = FALSE)
# 
# # miniBOX
# 
# behaviour_1304h_minibox <- st_read(paste0(data_generated_path_serveur, "behaviour_1304h_minibox.gpkg"))
# 
# behaviour_1304h_minibox_1000_56 <- behaviour_1304h_minibox %>%
#   group_by(id) %>%
#   mutate(nb_point = n()) %>%
#   mutate(nb_days = difftime(max(date), min(date), units = "days")) %>%
#   filter(nb_point >= 1000) %>%
#   filter(nb_days >= 28*2)
# 
# behaviour_1304h_nb_ind_1000_56 <- length(unique(behaviour_1304h_minibox_1000_56$id)) ; behaviour_1304h_nb_ind_1000_56
# 
# st_write(behaviour_1304h_minibox_1000_56, paste0(data_generated_path_serveur, "behaviour_1304h_minibox_1000_56.gpkg"), append = FALSE)
# 
# ###
# ####
# # VISUALISATION ----------------------------------------------------------------
...
# # miniBOX
# 
# behaviour_1304h_minibox_1000_56 <- st_read(paste0(data_generated_path_serveur, "behaviour_1304h_minibox_1000_56.gpkg"))
# 
# # group of individual for plots 
# behaviour_1304h_gp_ind <- behaviour_1304h_minibox_1000_56 %>% 
#   group_by(id) %>% 
#   st_drop_geometry() %>% 
#   dplyr::select(id, nb_point) %>% 
#   arrange(nb_point) %>%
#   distinct() 
# 
# behaviour_1304h_gp_ind_2 <- behaviour_1304h_gp_ind %>% 
#   bind_cols(group = rep(1:6, length.out = nrow(behaviour_1304h_gp_ind)))
# 
# dt_map_group_behaviour_1304h <- left_join(behaviour_1304h_minibox_1000_56, behaviour_1304h_gp_ind_2)
# 
# # map
# 
# tmap_mode("plot")
# behaviour_1304h_minibox_maps_1 <- tm_scale_bar() +
#   tm_shape(dept_minibox) +
#   tm_polygons() +
#   tm_shape(dt_map_group_behaviour_1304h) +
#   tm_dots(col = 'id', alpha = 0.5) +
#   tm_facets(by = c("group", "behavior"), free.coords = FALSE) +
#   tmap_options(max.categories = 70) +
#   tm_shape(RMO) +
#   tm_borders(col = "black"); behaviour_1304h_minibox_maps_1
# 
# tmap_save(behaviour_1304h_minibox_maps_1, paste0(data_image_path_serveur, "behaviour_1304h_minibox_1.png"), dpi = 600)
# 
# tmap_mode("plot")
# behaviour_1304h_minibox_maps_2 <- tm_scale_bar() +
#   tm_shape(dept_minibox) +
#   tm_polygons() +
#   tm_shape(dt_map_group_behaviour_1304h) +
#   tm_dots(col = 'id', alpha = 0.5) +
#   tm_facets(by = c("behavior"), free.coords = FALSE, nrow = 5, ncol = 4) +
#   tmap_options(max.categories = 70) +
#   tm_shape(RMO) +
#   tm_borders(col = "black"); behaviour_1304h_minibox_maps_2
# 
# tmap_save(behaviour_1304h_minibox_maps_2, paste0(data_image_path_serveur, "behaviour_1304h_minibox_2.png"), dpi = 600)
# 
# 
# tmap_mode("view")
# behaviour_1304h_minibox_maps_1 <- tm_scale_bar() +
...
# 
# # foraging : 1h30 avant-après la marée base 
# # roosting : 5h après la dernière marée basse, 5h avant la prochaine
# 
# aa <- inter_sf %>%
#   arrange(date)
# 
...
#   foraging_low = time_i - (3600*1.5)
#   foraging_up = time_i + (3600*1.5)
#   roosting_low = time_i + (3600*3)
#   roosting_up = time_i1 - (3600*3)
#   # assignation des behaviours
#   info <- aa %>%
#     mutate(behavior = case_when(between(date, foraging_low, foraging_up) ~ "foraging",
#                                 between(date, roosting_low, roosting_up) ~ "roosting")) %>%
...
# 
# # save
# write.table(behaviour_dt_1, paste0(data_generated_path_serveur, "behaviour_130430h.txt"),
#             append = FALSE, sep = ";", dec = ".", col.names = TRUE)
# 
# ###
# ####
...
# ###
# 
# behaviour_130430h <- read.table(paste0(data_generated_path_serveur, "behaviour_130430h.txt"), 
#                               header = T, sep = ";")
# behaviour_130430h_spa <- st_as_sf(behaviour_130430h, coords = c("x", "y"), crs = 4326)
# behaviour_130430h_spa$lon <- behaviour_130430h$x
# behaviour_130430h_spa$lat <- behaviour_130430h$y
# 
# # BOX
# # behaviour_130430h_box <- st_intersection(behaviour_130430h_spa, BOX_4326) # time consuming...
# # st_write(behaviour_130430h_box, paste0(data_generated_path_serveur, "behaviour_130430h_box.gpkg"), append = FALSE)
# 
# # miniBOX
# behaviour_130430h_minibox <- st_intersection(behaviour_130430h_spa, miniBOX_4326) # time consuming...
# st_write(behaviour_130430h_minibox, paste0(data_generated_path_serveur, "behaviour_130430h_minibox.gpkg"), append = FALSE)
# 
# ###
# ####
# # 1000 POINTS & 56 DAYS ---------------------------------------------------------
...
# 
# # BOX
# # behaviour_130430h_box <- st_read(paste0(data_generated_path_serveur, "behaviour_130430h_box.gpkg"))
# # 
# # behaviour_130430h_box_1000_56 <- behaviour_130430h_box %>%
# #   group_by(id) %>%
# #   mutate(nb_point = n()) %>%
# #   mutate(nb_days = difftime(max(date), min(date), units = "days")) %>%
# #   filter(nb_point >= 1000) %>%
# #   filter(nb_days >= 28*2)
# # 
# # behaviour_130430h_box_nb_ind_1000_56 <- length(unique(behaviour_130430h_box_1000_56$id)) ; behaviour_130430h_box_nb_ind_1000_56
# # 
# # st_write(behaviour_130430h_box_1000_56, paste0(data_generated_path_serveur, "behaviour_130430h_box_1000_56.gpkg"), append = FALSE)
# 
# # miniBOX
# 
# behaviour_130430h_minibox <- st_read(paste0(data_generated_path_serveur, "behaviour_130430h_minibox.gpkg"))
# 
# behaviour_130430h_minibox_1000_56 <- behaviour_130430h_minibox %>%
#   group_by(id) %>%
#   mutate(nb_point = n()) %>%
#   mutate(nb_days = difftime(max(date), min(date), units = "days")) %>%
#   filter(nb_point >= 1000) %>%
#   filter(nb_days >= 28*2)
# 
# behaviour_130430h_nb_ind_1000_56 <- length(unique(behaviour_130430h_minibox_1000_56$id)) ; behaviour_130430h_nb_ind_1000_56
# 
# st_write(behaviour_130430h_minibox_1000_56, paste0(data_generated_path_serveur, "behaviour_130430h_minibox_1000_56.gpkg"), append = FALSE)
# 
# ###
# ####
# # VISUALISATION ----------------------------------------------------------------
...
# # miniBOX
# 
# behaviour_130430h_minibox_1000_56 <- st_read(paste0(data_generated_path_serveur, "behaviour_130430h_minibox_1000_56.gpkg"))
# 
# # group of individual for plots 
# behaviour_130430h_gp_ind <- behaviour_130430h_minibox_1000_56 %>% 
#   group_by(id) %>% 
#   st_drop_geometry() %>% 
#   dplyr::select(id, nb_point) %>% 
#   arrange(nb_point) %>%
#   distinct() 
# 
# behaviour_130430h_gp_ind_2 <- behaviour_130430h_gp_ind %>% 
#   bind_cols(group = rep(1:6, length.out = nrow(behaviour_130430h_gp_ind)))
# 
# dt_map_group_behaviour_130430h <- left_join(behaviour_130430h_minibox_1000_56, behaviour_130430h_gp_ind_2)
# 
# # map
# 
# tmap_mode("plot")
# behaviour_130430h_minibox_maps_1 <- tm_scale_bar() +
#   tm_shape(dept_minibox) +
#   tm_polygons() +
#   tm_shape(dt_map_group_behaviour_130430h) +
#   tm_dots(col = 'id', alpha = 0.5) +
#   tm_facets(by = c("group", "behavior"), free.coords = FALSE, nrow = 5, ncol = 4) +
#   tmap_options(max.categories = 70) +
#   tm_shape(RMO) +
#   tm_borders(col = "black"); behaviour_130430h_minibox_maps_1
# 
# tmap_save(behaviour_130430h_minibox_maps_1, paste0(data_image_path_serveur, "behaviour_130430h_minibox_1.png"), dpi = 600)
# 
# tmap_mode("plot")
# behaviour_130430h_minibox_maps_2 <- tm_scale_bar() +
#   tm_shape(dept_minibox) +
#   tm_polygons() +
#   tm_shape(dt_map_group_behaviour_130430h) +
#   tm_dots(col = 'id', alpha = 0.5) +
...
#   tmap_options(max.categories = 70) +
#   tm_shape(RMO) +
#   tm_borders(col = "black"); behaviour_130430h_minibox_maps_2
# 
# tmap_save(behaviour_130430h_minibox_maps_2, paste0(data_image_path_serveur, "behaviour_130430h_minibox_2.png"), dpi = 600)
# 
# tmap_mode("view")
# behaviour_130430h_minibox_maps_1 <- tm_scale_bar() +
#   tm_shape(dt_map_group_behaviour_130430h) +
